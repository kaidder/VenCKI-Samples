System.register(['angular2/core', 'angular2/common', 'rxjs/Rx', 'angular2/http'], function(exports_1, context_1) {
    "use strict";
            ...
            AppComponent = (function () {
                function AppComponent(fb, http) {
                    ...
                    this.results = ctrl.valueChanges
                        .debounceTime(500)
                        .switchMap(function (fieldValue) { return _this.http.get("http://localhost:3001/api/search?term=" + fieldValue); })
